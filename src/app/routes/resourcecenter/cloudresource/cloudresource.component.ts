...
@Component({
    selector: 'app-cloudresource',
    templateUrl: './cloudresource.component.html',
    styleUrls: ['./cloudresource.component.less']
})
export class CloudresourceComponent implements OnInit {
